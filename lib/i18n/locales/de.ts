  ...
  privacyPhone: {
    ...
    cosaInclude: {
      ...
      items: [
        ...
        { key: 'connect', title: 'Connect — messaggistica post-quantum (primato tecnico)', body: 'Unico smartphone commerciale con ML-KEM FIPS 203 integrato. Nessun server centrale.' },
