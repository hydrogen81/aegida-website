...
const article: ArticleMeta = {
  ...
  locales: {
    it: {
      ...
      excerpt: 'Come il conflitto militare USA-Israele-Iran ha scatenato la piu vasta offensiva cyber per procura della storia recente \u2014 e perche le infrastrutture europee sono nel mirino di una rete pre-posizionata da anni. Analisi delle TTPs, catene di attacco e implicazioni strategiche.',
      body: [
        { type: 'paragraph', text: 'Il 28 febbraio 2026, Operation Epic Fury ha innescato una cascata cibernetica globale. Sessanta gruppi proxy iraniani gia pre-posizionati in ambienti cloud, sistemi SCADA e reti di fornitori europei hanno avviato operazioni coordinate. In 72 ore: 149 attacchi DDoS contro 110 organizzazioni in 16 paesi, 60+ gruppi mobilizzati, il 20% della fornitura globale di GNL interrotto e il wiper Handala che ha raggiunto 79 paesi.' },

        { type: 'heading', level: 2, text: 'Il Contesto Geopolitico: Tre Decenni di Dottrina Cibernetica Iraniana' },
        { type: 'paragraph', text: 'Il 28 febbraio 2026, missili e cacciabombardieri americani e israeliani hanno colpito installazioni militari iraniane, eliminando la Guida Suprema Khamenei e decapitando il vertice delle Guardie Rivoluzionarie (IRGC). Contemporaneamente, Israele ha condotto la piu grande operazione cyber offensiva della storia, collassando la connettivita internet iraniana all\'1-4% del traffico normale \u2014 dato confermato da NetBlocks.' },
        { type: 'paragraph', text: 'La risposta iraniana affonda le radici nel 2010. Stuxnet ha insegnato a Teheran che la cyberwar puo distruggere sistemi fisici isolati. Da allora l\'Iran ha costruito un ecosistema ibrido tra APT di Stato e collettivi hacktivisti che operano come proxy deniabili. L\'ecosistema e strutturato attorno a IRGC-CEC e MOIS, con APT33 (aerospace/energia), APT34/OilRig (Oil & Gas), APT35/APT42 (spear-phishing AI-assisted), MuddyWater (initial access broker) e Handala (hack-and-leak).' },

        { type: 'heading', level: 2, text: 'Il Patto Trilaterale Iran-Cina-Russia: un Nuovo Asse Cibernetico?' },
        { type: 'paragraph', text: 'Il 29 gennaio 2026 \u2014 un mese prima delle operazioni cinetiche \u2014 Iran, Cina e Russia hanno firmato a Teheran un patto strategico trilaterale. Sul fronte cyber, il patto consolida cooperazione gia esistente: la Cina ha fornito immagini satellitari e dati di early warning, la Russia ha concordato la ricostruzione dei sistemi di difesa aerea. La cooperazione include condivisione di infrastrutture per l\'anonimizzazione, scambio di vulnerabilita zero-day e tooling offensivo \u2014 come analizzato da Small Wars Journal e CSIS.' },

        { type: 'heading', level: 2, text: 'Anatomia dell\'Offensiva: TTPs, Timeline e Catene di Attacco' },
        { type: 'paragraph', text: 'Nelle prime 72 ore, una coalizione di oltre 12 gruppi ha eseguito 149 attacchi DDoS contro 110 organizzazioni in 16 paesi. Il numero di gruppi mobilizzati e salito a 60+, incluse formazioni filorusse come NoName057(16) che il 3 marzo si sono unite alla coalizione pro-iraniana \u2014 confermato da Tenable RSO, Palo Alto Unit 42, Flashpoint e Recorded Future.' },
        { type: 'callout', variant: 'warning', text: 'La vera minaccia era gia in posizione prima dell\'inizio delle operazioni cinetiche. L\'analisi di Tenable ha rivelato che MuddyWater aveva infiltrato reti israeliane e MENA nelle settimane precedenti con backdoor silenti. Il giorno dell\'operazione militare, quell\'accesso e stato armato. Questo \'weaponization of pre-positioned access\' e il paradigma operativo piu avanzato dell\'Iran.' },
        { type: 'paragraph', text: 'Il caso piu documentato e l\'attacco Handala contro Stryker Corporation dell\'11 marzo 2026. In tre ore, Handala ha cancellato gli endpoint di Stryker in 79 paesi su sei continenti. Stryker produce impianti ortopedici \u2014 nessun ruolo nel conflitto, nessuna operazione in Medio Oriente. L\'accesso era probabilmente ottenuto via Microsoft Intune o un vettore supply chain. Linee di produzione ferme. Ospedali in attesa di dispositivi chirurgici che hanno ricevuto silenzio.' },

        { type: 'heading', level: 2, text: 'Il Rischio Europeo: Non Siamo Osservatori' },
        { type: 'paragraph', text: 'L\'Europa e una superficie di attacco, non uno spettatore. NoName057(16) ha condotto campagne DDoS in Romania e Danimarca. DieNet ha affermato 100 attacchi in un solo giorno. L\'operazione Handala ha raggiunto organizzazioni in 16 paesi europei attraverso la supply chain. La Finlandia, nel suo National Security Overview 2026, ha esplicitamente segnalato l\'Iran come vettore di rischio accanto a Russia e Cina.' },
        { type: 'paragraph', text: 'Per l\'Italia il rischio e specifico: basi NATO (Aviano, Sigonella, Napoli) come obiettivi simbolici, il porto di Gioia Tauro come target di disruption portuale, il settore energetico esposto alla chiusura dello Stretto di Hormuz e all\'interruzione del 20% della fornitura globale di GNL. Ogni organizzazione italiana con filiali, fornitori o partner digitali nell\'area Golfo deve considerarsi in scope.' },
        { type: 'callout', variant: 'tip', text: 'La domanda da porsi non e \'siamo stati attaccati?\' ma \'siamo gia stati compromessi senza saperlo?\'. APT33 targetta il settore aerospaziale e Oil & Gas europeo. APT34/OilRig colpisce aziende europee per accedere ai controllori industriali. MuddyWater punta a telecomunicazioni e vendor IT come trampolino verso target di maggiore valore.' },
        ...
        { type: 'paragraph', text: 'L\'analisi di Tenable ha identificato oltre 15,5 milioni di asset vulnerabili nei sette paesi target. Una singola vulnerabilita \u2014 CVE-2026-21514, bypass OLE in Microsoft Word \u2014 account per quasi 14 milioni di quei target. Aggiunta al catalogo CISA KEV il 10 febbraio 2026, APT28 russo l\'aveva gia sfruttata nel gennaio 2026 contro target in Ucraina, Slovacchia e Romania \u2014 possibile exploit-sharing tra la rete russo-iraniana.' },

        { type: 'heading', level: 2, text: 'Perche il Post-Quantum e Rilevante Oggi, Non Domani' },
        { type: 'paragraph', text: 'La proliferazione di attori con accesso pre-posizionato introduce il problema del \'harvest now, decrypt later\'. I gruppi iraniani, con supporto tecnico cinese e russo, stanno raccogliendo traffico cifrato intercettato per decifrarlo retroattivamente con futuri computer quantistici. Per le organizzazioni europee che trattano informazioni sensibili \u2014 difesa, energia, farmaceutica \u2014 la crittografia attuale (RSA, ECC) non garantisce confidenzialita nemmeno per dati gia trasmessi.' },
        { type: 'paragraph', text: 'Il caso Stryker ha dimostrato che la velocita di esecuzione di un\'operazione distruttiva \u2014 tre ore per 79 paesi \u2014 supera drammaticamente la velocita di risposta dei team SOC tradizionali. Un modello Zero Trust con micro-segmentazione, autenticazione continua e crittografia post-quantistica NIST (ML-KEM per key encapsulation, ML-DSA per firme digitali) riduce la superficie di lateralizzazione. Questo non e un argomento di marketing: e la differenza tra un incidente contenuto e un wipe globale.' },
        ...
        { type: 'list', ordered: true, items: [
          ...
          'Potenziamento delle capacita DDoS mitigation, con verifica della resilienza su DNS e BGP',
        ]},
        { type: 'callout', variant: 'info', text: 'Il quadro NIS2, in vigore per tutti gli operatori di servizi essenziali europei, impone esattamente questi requisiti come minimo, non come massimo. Operation Epic Fury non e un evento circoscritto al Medio Oriente: e un catalizzatore che ha attivato una rete globale pre-esistente, progettata per operare autonomamente.' },

        { type: 'paragraph', text: 'Il quadro geopolitico attuale, con la convergenza tra capacita iraniane, supporto cinese e coordinamento filorusso, rappresenta esattamente lo scenario per cui la migrazione verso crittografia post-quantistica e Zero Trust non e una roadmap triennale: e una priorita operativa immediata.' },
      ],
    },
    en: {
