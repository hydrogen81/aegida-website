...
const article: ArticleMeta = {
  ...
  locales: {
    it: {
      ...
      body: [
        { type: 'paragraph', text: 'L\'attacco SolarWinds SUNBURST rappresenta uno dei piu sofisticati e consequenziali attacchi informatici nella storia della cybersecurity. Un gruppo APT, attribuito al servizio di intelligence russo SVR (APT29/Cozy Bear), ha compromesso il processo di build del software Orion Platform di SolarWinds, inserendo una backdoor in un aggiornamento legittimo distribuito a circa 18.000 organizzazioni in tutto il mondo. L\'attacco e rimasto non rilevato per oltre 14 mesi, colpendo agenzie federali statunitensi, aziende Fortune 500 e la stessa FireEye, che alla fine ne ha scoperto l\'esistenza.' },

        { type: 'heading', level: 2, text: 'Timeline dettagliata: dalla compromissione alla scoperta' },
        { type: 'paragraph', text: 'La ricostruzione forense ha rivelato una timeline che testimonia la pazienza e la disciplina operativa degli attaccanti. Ogni fase e stata eseguita con estrema cautela, minimizzando le tracce e massimizzando la persistenza.' },
        { type: 'list', ordered: true, items: [
          ...
          'Febbraio 2020: viene iniettato il payload SUNBURST completo nel codice sorgente di Orion. La backdoor e inserita nella DLL SolarWinds.Orion.Core.BusinessLayer.dll, una libreria legittima firmata digitalmente da SolarWinds.',
          'Marzo 2020: l\'aggiornamento Orion versione 2019.4 HF 5 viene distribuito ai clienti attraverso i canali ufficiali. La firma digitale valida garantisce che nessun controllo di integrita rilevi l\'anomalia.',
        ...
        { type: 'list', ordered: false, items: [
          ...
          'Dormancy period: il periodo di inattivita iniziale di 12-14 giorni era progettato per eludere le sandbox automatiche, che tipicamente analizzano il comportamento del software per periodi molto piu brevi (minuti o ore).',
        ...
        { type: 'paragraph', text: 'AEGIDA Framework e stato progettato specificamente per affrontare scenari come SolarWinds, dove la minaccia proviene dall\'interno della supply chain software. L\'architettura di AEGIDA implementa molteplici livelli di difesa che avrebbero significativamente limitato l\'impatto dell\'attacco.' },
        { type: 'list', ordered: false, items: [
          'Stealth Layer: il layer di invisibilita di AEGIDA rende l\'infrastruttura protetta non enumerabile dagli attaccanti. Anche con una backdoor attiva nel sistema di monitoraggio, gli asset critici sarebbero rimasti invisibili alla ricognizione automatica di SUNBURST, impedendo il lateral movement verso i target di valore.',
          'Zero-Trust OEM Access: AEGIDA implementa un modello di accesso zero-trust per ogni fornitore e componente software. Gli aggiornamenti non ereditano automaticamente i privilegi del software precedente: ogni sessione e autenticata con certificati post-quantum, autorizzata per scope specifico, limitata nel tempo e completamente tracciata.',
          ...
          'Verifica continua dell\'integrita: AEGIDA esegue verifiche crittografiche continue sull\'integrita dei binari in esecuzione, confrontandoli con hash firmati post-quantum. Qualsiasi modifica alla DLL di Orion sarebbe stata rilevata indipendentemente dalla validita della firma digitale tradizionale.',
        ]},
        ...
        { type: 'paragraph', text: 'L\'attacco SolarWinds non e stato un caso isolato ma il paradigma di una nuova era di minacce. Gli attacchi alla supply chain continueranno a evolversi in sofisticazione, e la prossima generazione sara probabilmente potenziata dall\'intelligenza artificiale e dalla capacita di sfruttare vulnerabilita crittografiche quantistiche. Le organizzazioni che non adottano oggi un approccio zero-trust con crittografia post-quantum si troveranno esposte a rischi sempre maggiori. Il passaggio da un modello di fiducia implicita a uno di verifica continua non e piu opzionale: e un requisito di sopravvivenza.' },
      ],
    },
    en: {
