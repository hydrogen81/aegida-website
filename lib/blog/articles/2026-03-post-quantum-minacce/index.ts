...
const article: ArticleMeta = {
  ...
  locales: {
    it: {
      title: 'Store-Now-Decrypt-Later: perche le tue comunicazioni di oggi sono gia a rischio',
      excerpt: 'I computer quantistici non sono ancora operativi, ma la minaccia e gia reale. Ecco come funziona l\'attacco "store-now-decrypt-later" e come proteggersi con la crittografia post-quantum.',
      body: [
        { type: 'paragraph', text: 'Esiste una minaccia informatica che non richiede un attacco diretto, non lascia tracce nei log e non attiva nessun allarme. Si chiama "store-now-decrypt-later" (SNDL) e sta gia accadendo. Agenzie di intelligence, gruppi APT e attori statali stanno intercettando e archiviando enormi quantita di traffico cifrato, con l\'obiettivo di decrittarlo in futuro quando i computer quantistici saranno operativi.' },
        ...
        { type: 'list', ordered: true, items: [
          ...
          'Quando la capacita computazionale sara disponibile, algoritmi come quello di Shor potranno rompere RSA, ECC e Diffie-Hellman in poche ore.',
          'Tutti i dati archiviati — contratti, comunicazioni strategiche, segreti industriali — diventeranno leggibili.',
        ]},
        { type: 'heading', level: 2, text: 'Non e fantascienza' },
        { type: 'paragraph', text: 'La NSA, il NCSC britannico e il BSI tedesco hanno pubblicamente confermato che la minaccia SNDL e reale e attuale. Il NIST ha finalizzato gli standard post-quantum (FIPS 203, ML-KEM) nell\'agosto 2024 proprio per rispondere a questa urgenza. La timeline stimata per un computer quantistico crittograficamente rilevante varia tra i 5 e i 15 anni — ma i dati intercettati oggi avranno ancora valore strategico tra 10, 20 o 30 anni.' },
        { type: 'callout', variant: 'warning', text: 'Se le tue comunicazioni contengono informazioni che saranno ancora sensibili tra 10 anni — contratti, proprietà intellettuale, dati personali, strategie — l\'attacco SNDL ti riguarda gia oggi.' },
        { type: 'heading', level: 2, text: 'La soluzione: crittografia post-quantum' },
        { type: 'paragraph', text: 'La migrazione verso algoritmi post-quantum come ML-KEM (FIPS 203) e l\'unica contromisura efficace contro SNDL. Questi algoritmi sono basati su problemi matematici (reticoli strutturati) che rimangono computazionalmente intrattabili anche per i computer quantistici.' },
        { type: 'paragraph', text: 'AEGIDA Framework implementa ML-KEM per lo scambio di chiavi, combinato con AES-256-GCM per la cifratura simmetrica e uno stealth layer che rende il traffico indistinguibile dal normale HTTPS. Questo approccio a tre livelli protegge sia dai futuri attacchi quantistici che dalle tecniche di intercettazione e analisi del traffico gia disponibili oggi.' },
        { type: 'heading', level: 2, text: 'Cosa fare adesso' },
        { type: 'paragraph', text: 'La transizione alla crittografia post-quantum non e un progetto del futuro: e un\'urgenza del presente. Ogni giorno di ritardo e un giorno in piu di dati potenzialmente intercettati e archiviati. Le organizzazioni che gestiscono infrastrutture critiche, dati sanitari, informazioni finanziarie o segreti industriali dovrebbero iniziare la migrazione PQC immediatamente.' },
      ],
    },
    en: {
