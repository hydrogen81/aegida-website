    ...
    <main className="min-h-screen bg-navy-950 text-slate-200">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '1.5rem' }}>
            {t.privacyPhone.cosaInclude.items.map((item) => (
              <div key={item.key} className="rounded border border-navy-700 bg-navy-900 p-6 h-full transition-colors duration-200 hover:border-gold-500/40">
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '1.5rem' }}>
            {t.privacyPhone.proof.timeline.map((step, i) => (
              <div key={i} className="rounded-lg border border-navy-700 bg-navy-900 overflow-hidden h-full flex flex-col">
      ...
      <section id="pricing" className="py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '1.5rem' }}>
            {t.privacyPhone.pricing.packages.map((pkg) => (
              <div
                key={pkg.name}
